        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds:snapshot.getChildren()){
                    ...
                    totalAmountSpentOn.setText("Total today's spending: Rs."+totalAmount);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(notes)){
                    ...
                    loader.setTitle("adding a budget item");
                    ...
                    Data data = new Data(Item, date, id, notes,null,Integer.parseInt(Amount), months.getMonths(),weeks.getWeeks());
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(TodaySpendingActivity.this,"Failed to add Budget Item", Toast.LENGTH_SHORT).show();
                            }
                            loader.dismiss();
                        }
                    });
