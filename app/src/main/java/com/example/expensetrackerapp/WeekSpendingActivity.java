    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras()!=null)
        {
            ...
            if(type.equals("week")){
                ...
                getSupportActionBar().setTitle("This Week's Spending");
            }
            else if(type.equals("month")){
                readMonthSpendingItems();
                getSupportActionBar().setTitle("This Month's Spending");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    totalWeekAmountTextView.setText("Total Months Spending: Rs." + totalAmount);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    totalWeekAmountTextView.setText("Total Weeks Spending: Rs." + totalAmount);
